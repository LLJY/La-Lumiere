...
public class Loading {
    private static String[] loadingMessages = {"Reticulating splines...",
    ...
    public static ProgressDialog showWittyLoadingDialog(Context context){
        // pick random loading dialog
        String message = loadingMessages[new Random().nextInt(loadingMessages.length)];
        return (ProgressDialog.show(context, message, "Please Be Patient"));
    }
}
